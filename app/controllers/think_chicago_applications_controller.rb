class ThinkChicagoApplicationsController < ApplicationController
  ...
  def create
    ...
    if @think_chicago_application.save
      ...
      render 'application/confirmation', :locals => {:title => "ThinkChicago Application Confirmation", :body => "Thank you for applying to ThinkChicago 2012.", :url => "http://bit.ly/NXyJJ9", :share_text => "I applied to ThinkChicago 2012 at @chicagoideas! RT to all #innovative #socent! Apply today: http://bit.ly/NXyJJ9"}
